    ...
    <section className="bg-surface py-24 md:py-32 px-6 md:px-12">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div>
            <span className="font-mono text-brass text-xs tracking-[0.3em] uppercase block mb-4">How It Works</span>
          ...
          <Link
            href="/work-with-us/"
            className="group inline-flex items-center gap-3 font-mono text-brass text-xs tracking-[0.2em] uppercase border border-brass/30 px-6 py-3 hover:border-brass hover:bg-brass hover:text-charcoal transition-all duration-300 self-start md:self-auto"
          >
